    ...
    <body>
        ...
        <div class="container">
            ...
            <h2> 
                ...
                if ($_SESSION["night_records"] ==1 && $_SESSION["day_records"] ==1 ){
                     echo "You can attempt to visit the secret site at  PRICELESS-WING.CLOUD . <br> You would need to remember the security answer that you set. <br> ";
               }
             

                if ($currentHour >= 7 && $currentHour < 19 && $_SESSION["day_records"] !=1 ) {
                   echo "Day Period is from 7am to 7pm <br> ";
                    echo "Currently in Day Period. Please click Day to do the tests. <br> You would need to do the tests 2 times once with Mouse and the other with Trackpad.   <br> ";
                    $_SESSION["time_period"] = "day";
                } else if ($_SESSION['night_records'] !=1   ) {
                    echo "Night Period is from 7pm to 7am <br> ";
                    echo "Currently Night Period. Please click Night to do the tests. <br>  You would need to do the tests 2 times once with Mouse and the other with Trackpad.  <br> ";
...
// SQL query to retrieve the questions that the user had completed for captcha
        ...
        <script>
            ...
            function checkSessionDay() {
                ...
                if (curr_period === "day" && day_records === '0' && (countdownStatus=='0' || countdownStatus =='-1')) {
            ...
            function checkSessionNight() {
               ...
               console.log(curr_period);
                if (curr_period === "night" && night_records === '0' && (countdownStatus=='-1' || countdownStatus =='0')) {
                    window.location.href = 'captcha_challenge.php';
